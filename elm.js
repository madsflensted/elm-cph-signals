...
Elm.Center = Elm.Center || {};
Elm.Center.make = function (_elm) {
   "use strict";
   _elm.Center = _elm.Center || {};
   if (_elm.Center.values) return _elm.Center.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var style = function (width) {
      return $Html$Attributes.style(_U.list([A2(_op["=>"],"display","block"),A2(_op["=>"],"width",width),A2(_op["=>"],"margin","0 auto")]));
   };
   var markdown = F2(function (width,string) {
      return A2($Html.div,_U.list([$Html$Attributes.$class("content"),style(width)]),_U.list([$Markdown.toHtml(string)]));
   });
   return _elm.Center.values = {_op: _op,markdown: markdown,style: style};
};
...
Elm.Main.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "Increment": return _U.update(model,{index: A2($Basics._op["%"],model.index + 1,$List.length(model.slides))});
         case "Decrement": return _U.update(model,{index: A2($Basics._op["%"],model.index - 1,$List.length(model.slides))});
         default: return model;}
   });
   var NoOp = {ctor: "NoOp"};
   var Decrement = {ctor: "Decrement"};
   var Increment = {ctor: "Increment"};
   var interpretArrows = function (arrows) {
      var _p1 = {ctor: "_Tuple2",_0: arrows.x,_1: arrows.y};
      _v1_4: do {
         if (_p1.ctor === "_Tuple2") {
               switch (_p1._0)
               {case -1: return Decrement;
                  case 1: return Increment;
                  default: switch (_p1._1)
                    {case 1: return Decrement;
                       case -1: return Increment;
                       default: break _v1_4;}}
            } else {
   ...
   var inputs = _U.list([A2($Signal.map,interpretArrows,$Keyboard.arrows)]);
   ...
   var initialModel = {index: 0,slides: $Slides.allSlides};
   var addNoneEffect = function (model) {    return {ctor: "_Tuple2",_0: model,_1: $Effects.none};};
   _op["->>"] = F4(function (f,g,a,b) {    return g(A2(f,a,b));});
   var app = $StartApp.start({init: addNoneEffect(initialModel),view: view,update: A2(_op["->>"],update,addNoneEffect),inputs: inputs});
   var main = app.html;
   return _elm.Main.values = {_op: _op
                             ,main: main
                             ,addNoneEffect: addNoneEffect
                             ,app: app
                             ...
                             ,NoOp: NoOp
                             ,update: update
                             ,interpretArrows: interpretArrows
                             ,inputs: inputs};
};
